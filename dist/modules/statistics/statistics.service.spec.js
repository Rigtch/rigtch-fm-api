...
(0, _vitest.describe)('StatisticsService', ()=>{
    ...
    (0, _vitest.test)('should get last tracks', async ()=>{
        _vitest.vi.spyOn(httpService, 'get').mockReturnValue((0, _rxjs.of)((0, _utils.axiosResponseMockFactory)((0, _mocks.spotifyResponseMockFactory)(Array.from({
            length: 5
        }).map(()=>({
                track: _mocks.spotifyTrackMock,
                played_at: '2022-11-26T11:01:10.040Z'
            }))))));
        (0, _vitest.expect)(await (0, _rxjs.firstValueFrom)(statisticsService.lastTracks('awd'))).toEqual((0, _mocks.spotifyResponseMockFactory)(_mocks.formattedTracksMock));
    });
    (0, _vitest.test)('should get top artists', async ()=>{
        ...
        (0, _vitest.expect)(await (0, _rxjs.firstValueFrom)(statisticsService.topArtists('awd'))).toEqual((0, _mocks.spotifyResponseMockFactory)(_mocks.formattedArtistsMock));
    });
    ...
    (0, _vitest.test)('should get top tracks', async ()=>{
        _vitest.vi.spyOn(httpService, 'get').mockReturnValue((0, _rxjs.of)((0, _utils.axiosResponseMockFactory)((0, _mocks.spotifyResponseMockFactory)(_mocks.spotifyTracksMock))));
        (0, _vitest.expect)(await (0, _rxjs.firstValueFrom)(statisticsService.topTracks('awd'))).toEqual((0, _mocks.spotifyResponseMockFactory)(_mocks.formattedTracksMock));
    });
