...
(0, _vitest.describe)('StatisticsService', ()=>{
    ...
    (0, _vitest.test)('should get last tracks', async ()=>{
        ...
        (0, _vitest.expect)(await (0, _rxjs.firstValueFrom)(statisticsService.lastTracks('awd'))).toEqual(_mocks.formattedTracksMock);
    });
    (0, _vitest.test)('should get top artists', async ()=>{
        _vitest.vi.spyOn(httpService, 'get').mockReturnValue((0, _rxjs.of)((0, _utils.axiosResponseMockFactory)({
            items: _mocks.spotifyArtistsMock
        })));
        (0, _vitest.expect)(await (0, _rxjs.firstValueFrom)(statisticsService.topArtists('awd'))).toEqual(_mocks.formattedArtistsMock);
    });
    ...
    (0, _vitest.test)('should get top tracks', async ()=>{
        _vitest.vi.spyOn(httpService, 'get').mockReturnValue((0, _rxjs.of)((0, _utils.axiosResponseMockFactory)({
            items: _mocks.spotifyTracksMock
        })));
        (0, _vitest.expect)(await (0, _rxjs.firstValueFrom)(statisticsService.topTracks('awd'))).toEqual(_mocks.formattedTracksMock);
    });
    ...
    (0, _vitest.test)('should generate analysis', async ()=>{
        _vitest.vi.spyOn(statisticsService, 'topTracks').mockReturnValue((0, _rxjs.of)(_mocks.formattedTracksMock));
        _vitest.vi.spyOn(httpService, 'get').mockReturnValue((0, _rxjs.of)((0, _utils.axiosResponseMockFactory)({
            audio_features: [
