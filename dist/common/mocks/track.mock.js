/* eslint-disable sonarjs/no-duplicate-string */ "use strict";
...
_export(exports, {
    spotifyTrackMock: function() {
        return spotifyTrackMock;
    },
    spotifyTracksMock: function() {
        return spotifyTracksMock;
    },
    formattedTrackMock: function() {
        return formattedTrackMock;
    },
    formattedTracksMock: function() {
        return formattedTracksMock;
    }
});
const spotifyTrackMock = {
    album: {
        album_type: 'album',
        artists: [
            {
    ...
    name: 'Kobresia',
    popularity: 34,
    preview_url: 'https://p.scdn.co/mp3-preview/8c2821473d727e05b137d82d5a484076888aa4be?cid=774b29d4f13844c495f206cafdad9c86',
    track_number: 7,
    type: 'track',
    uri: 'spotify:track:5O6MFTh1rd9PeN8XEn1yCS',
    played_at: '2022-11-26T11:01:10.040Z'
};
const spotifyTracksMock = Array.from({
    length: 5
}).map(()=>spotifyTrackMock);
const formattedTrackMock = {
    id: '5O6MFTh1rd9PeN8XEn1yCS',
    album: {
        name: 'Substrata + Man with a Movie Camera',
        images: [
...
const formattedTracksMock = Array.from({
    length: 5
}).map(()=>formattedTrackMock) /* eslint-enable sonarjs/no-duplicate-string */ ;

//# sourceMappingURL=track.mock.js.map